...
Данный проект — реальное IaC-развёртывание инфраструктуры в **Yandex Cloud** для веб-приложения [`health-api`](https://gitlab.com/vikgur/health-api-for-microservice-stack): сеть, виртуальные машины под k3s-кластер и сопутствующие ресурсы. Репозиторий реализован на **Terraform + Terragrunt** с поддержкой [Makefile](#запуск-через-makefile) и [DevSecOps-практиками](#внедренные-devsecops-практики).
