...
Данный проект — рабочее автоматизированное конфигурационное управление для веб-приложения [`health-api`](https://gitlab.com/vikgur/health-api-for-microservice-stack) с использованием **Ansible** и **GitOps на базе Argo CD**.  
...
* применение конфигурации Projects, RBAC и Git-репозиториев из [`argocd-config-health-api`](https://gitlab.com/vikgur/argocd-config-health-api);  
* применение Argo CD Applications (`stage`, `prod`) из [`gitops-apps-health-api`](https://gitlab.com/vikgur/gitops-apps-health-api) с автоматическим подтягиванием манифестов по переменной окружения;
...
> Подробное описание ролей и плейбуков для Fallback/Manual-сценария — в отдельном репозитории [ansible-manual-health-api](https://gitlab.com/Vikgur/ansible-manual-health-api).
